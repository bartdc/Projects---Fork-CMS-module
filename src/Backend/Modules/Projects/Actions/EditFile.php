...
/**
 * This is the edit file action, it will display a form to edit an existing project file.
 *
...
class EditFile extends BackendBaseActionEdit
{
	...
	public function execute()
	{
		...
		if($this->id !== null && BackendProjectsModel::existsFile($this->id))
		{
			parent::execute();
	...
	protected function getData()
	{
		...
		$this->file = BackendProjectsModel::getFile($this->getParameter('id', 'int'));
	...
	protected function validateForm()
	{
		...
		if($this->frm->isSubmitted())
		{
			...
			if($this->frm->isCorrect())
			{
				...
				// save the item
				$id = BackendProjectsModel::saveFile($item);
